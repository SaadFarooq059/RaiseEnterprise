export default function GrowthSection() {
  return (
    <div className="mb-12 md:mb-16 max-w-[1200px]">
      <div className="flex flex-col md:flex-row gap-6 md:gap-8">
        ...
        <div 
  className="absolute mt-40 -left-12 md:-left-5 
             text-[#A564F7] text-base md:text-[23px] 
             font-manrope font-bold leading-tight 
             md:leading-[58px] whitespace-nowrap z-0"
...
>
  Sector Growth
          ...
          {/* H3 Heading */}
          <h3 className="relative z-10 text-[#9B2683] text-2xl md:text-[32px] font-manrope font-bold leading-tight md:leading-[32px]">
            Growth in<br />
            Membership &<br />
            Revenues
          </h3>
