    ...
    <div className="mb-12 md:mb-16 md:ml-8 lg:ml-12 xl:ml-16">
      ...
      <div className="mb-8 md:mb-12">
        ...
        <h2 className="mb-6 md:mb-8 font-aleo text-2xl md:text-[36px] font-medium leading-tight md:leading-[44px] text-[#9B2683]">
          <span className="font-medium">Augmented </span>
      ...
      <div className="space-y-8 md:space-y-0">
        ...
        <div className="mb-8 md:mb-12">
          <div className="border-t border-[#9B2683] mb-6 md:mb-8" />
          <div className="flex flex-col md:flex-row gap-6 md:gap-8">
            <div className="flex-shrink-0">
              <img 
                src="/social/logo1.png" 
                alt="raiSE Impact Community Logo"
                className="w-[120px] md:w-[158px] h-auto object-contain"
              />
            </div>
            <div className="flex-1 max-w-full md:max-w-[596px]">
              <h3 className="text-[#9B2683] text-xl md:text-[24px] font-manrope font-bold leading-tight md:leading-[24px] mb-4 md:mb-6">
                raiSE Impact Community
              </h3>
              <div className="mb-4 md:mb-6">
                ...
                <p className="text-black text-base md:text-[18px] font-manrope font-medium leading-relaxed md:leading-[23.4px] mb-4">
                  ACRA-registered company<br/>
                  Reflecting intentionality to integrate social impact strategically into business model
                </p>
              </div>
              <p className="text-black text-base md:text-[18px] font-manrope font-medium leading-relaxed md:leading-[23.4px]">
        ...
        <div className="mb-8 md:mb-12">
          ...
          <div className="flex flex-col md:flex-row gap-6 md:gap-8">
            ...
            <div className="flex-1 max-w-full md:max-w-[603px]">
              <h3 className="text-[#9B2683] text-xl md:text-[24px] font-manrope font-bold leading-tight md:leading-[24px] mb-4 md:mb-6">
                Emerging Social Enterprises
              </h3>
              <div className="mb-4 md:mb-6">
                <p className="text-[#A374FF] text-lg md:text-[20px] font-manrope font-bold leading-tight md:leading-[26px] mb-3">
                ...
                <p className="text-black text-base md:text-[18px] font-manrope font-medium leading-relaxed md:leading-[23.4px] mb-4">
                  &gt; 3 months of social impact creating and measuring<br/>
                  Revenue generating business<br/>
                  Incorporated sustained efforts to address identified social gaps and impact areas
                </p>
              </div>
              <p className="text-black text-base md:text-[18px] font-manrope font-medium leading-relaxed md:leading-[23.4px]">
        ...
        <div className="mb-8 md:mb-12">
          ...
          <div className="flex flex-col md:flex-row gap-6 md:gap-8">
            ...
            <div className="flex-1 max-w-full md:max-w-[624px]">
              <h3 className="text-[#9B2683] text-xl md:text-[24px] font-manrope font-bold leading-tight md:leading-[24px] mb-4 md:mb-6">
                Leading Social Enterprises
              </h3>
              <div className="mb-4 md:mb-6">
                ...
                <p className="text-black text-base md:text-[18px] font-manrope font-medium leading-relaxed md:leading-[23.4px] mb-4">
                  &gt; 1 year of creating and measuring social impact<br/>
                  20% proportionality of social impact relative to size of business<br/>
                  Minimally $250,000 annual revenue<br/>
                  Achieved &gt;50% trading revenue
                </p>
              </div>
              <p className="text-black text-base md:text-[18px] font-manrope font-medium leading-relaxed md:leading-[23.4px]">
            ...
            <div className="flex flex-col md:flex-row gap-6 md:gap-8">
              <div className="flex-shrink-0">
                <img 
                  ...
                  className="w-[120px] md:w-[148px] h-auto object-contain"
                />
              </div>
              <div className="flex-1 max-w-full md:max-w-[562px]">
                <h3 className="text-[#9B2683] text-xl md:text-[24px] font-manrope font-bold leading-tight md:leading-[24px] mb-4 md:mb-6">
                  Verified Leading Social Enterprises
                </h3>
                <div className="mb-4 md:mb-6">
                  ...
                  <p className="text-black text-base md:text-[18px] font-manrope font-medium leading-relaxed md:leading-[23.4px] mb-4">
                    Leading Social Enterprise for &gt; 1 year<br/>
                    Successfully completed raiSE verification process to validate Social Impact and Financial Sustainability
                  </p>
                </div>
                <p className="text-black text-base md:text-[18px] font-manrope font-medium leading-relaxed md:leading-[23.4px]">
