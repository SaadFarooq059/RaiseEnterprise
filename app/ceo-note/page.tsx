      ...
      <div className="relative overflow-hidden">
        <div className="flex flex-col md:grid md:grid-cols-[1fr_1fr] xl:grid-cols-[1000px_1fr] md:h-screen">
          ...
          <div className="bg-[#FCD290] px-6 py-8 sm:px-8 sm:py-10 md:px-6 md:py-8 lg:px-10 xl:px-16 flex flex-col justify-center min-h-[50vh] md:min-h-0">
            ...
            {/* Quote */}
            <p className="text-[#8F2576] text-[16px] sm:text-[17px] md:text-[16px] lg:text-[20px] xl:text-[28px] font-['Aleo'] font-bold leading-[24px] sm:leading-[26px] md:leading-[24px] lg:leading-[30px] xl:leading-[42px] mb-3 sm:mb-4 md:mb-4 lg:mb-6 xl:mb-8">
              "As we enter the impact decade, only
              those who deliver meaningful social
              change alongside business excellence
