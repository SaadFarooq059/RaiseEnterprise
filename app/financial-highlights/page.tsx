...
export default function FinancialHighlights() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div 
        className="fixed top-0 left-0 right-0 h-34 z-30"
      ...
      <div ref={reportRef} data-pdf-content className="bg-white">
        {/* Hero Section */}
          ...
          <div className="w-full px-6 md:px-12 lg:px-24 flex flex-col md:flex-row justify-between items-center md:items-end gap-8 md:gap-12">
            ...
            <div className="flex flex-col items-center md:items-start gap-6 w-full md:w-auto">
              ...
              <button 
                ...
                className="flex items-center gap-3 cursor-pointer hover:opacity-100 transition-all opacity-90 mt-2"
              >
                <svg className="w-8 h-8 md:w-10 md:h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />
                </svg>
                <span className="text-white text-[14px] md:text-[16px] lg:text-[20px] font-['Manrope'] font-medium">DOWNLOAD FULL REPORT</span>
              </button>
            </div>
