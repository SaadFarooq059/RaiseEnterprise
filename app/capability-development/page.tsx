  ...
  return (
    <div className="min-h-screen w-full relative overflow-hidden">
      ...
      >
        ...
        <div className="w-full py-20 flex justify-center">
          <div className="w-full max-w-[1200px] px-6">
            ...
            <div className="mt-12 grid grid-cols-1 md:grid-cols-4">
              ...
              >
                <img src="/development/icon-1.png" alt="Icon 1" style={{width: '100%', height: '100%', maxWidth: '80px', maxHeight: '80px'}} />
                <div 
              ...
              >
                <img src="/development/icon-2.png" alt="Icon 2" style={{width: '100%', height: '100%', maxWidth: '80px', maxHeight: '80px'}} />
                <div 
                  className="mt-auto pt-12"
                  style={{
                    color: 'white',
              ...
              >
                <img src="/development/icon-3.png" alt="Icon 3" style={{width: '100%', height: '100%', maxWidth: '80px', maxHeight: '80px'}} />
                <div 
                  className="mt-auto pt-12"
                  style={{
                    color: 'white',
              ...
              >
                <img src="/development/icon-4.png" alt="Icon 4" style={{width: '100%', height: '100%', maxWidth: '80px', maxHeight: '80px'}} />
                <div 
                  className="mt-auto pt-12"
                  style={{
                    color: 'white',
        ...
        <div className="w-full">
          <img 
            src="/development/bottom-image.jpg" 
            alt="Workshop" 
