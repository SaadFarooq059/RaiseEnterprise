  ...
  return (
    <>
      <main id="top" className="min-h-screen">
        ...
        {/* Report Overview Section with Gradient */}
        <div style={{ background: "linear-gradient(180deg, #4A2281 5%, #681968 12%, #7A56C4 100%)" }}>
          {/* Report Overview Title */}
          <div className="px-4 pt-8 lg:pt-40 pb-6 lg:pb-12">
            <h1
              className={`ml-4 lg:ml-[370px] font-serif text-3xl lg:text-4xl capitalize text-white transition-all duration-1000 delay-700 ${
          ...
          <div className="mx-auto max-w-[1200px] px-4 pb-20 lg:pl-20">
            ...
            <div className="flex flex-col gap-y-6 lg:hidden">
              {cards.map((card, index) => (
                <div
                  key={index}
                  className={`transition-all duration-1000 delay-[${900 + index * 100}ms] ${
                    isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
                  }`}
                >
                  <ReportCard
              ...
              <div className="flex flex-col gap-y-8 lg:w-1/2">
                ...
                >
                  <ReportCard
                    ...
                    imageHeight={cards[0].imageHeight}
                ...
                >
                  <ReportCard
                    ...
                    imageHeight={cards[2].imageHeight}
              ...
              <div className="flex flex-col gap-y-8 lg:w-1/2 lg:pt-32">
                ...
                >
                  <ReportCard
                    ...
                    imageHeight={cards[1].imageHeight}
                ...
                >
                  <ReportCard
                    ...
                    imageHeight={cards[3].imageHeight}
                ...
                <div
                  className={`transition-all duration-1000 delay-[1400ms] ${
                    isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
                  }`}
                >
                  <ReportCard
                    ...
                    imageHeight={cards[5].imageHeight}
